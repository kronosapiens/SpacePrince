...
const JOY_AFFLICTED_THRESHOLD = 96;
...
const self_stillWater: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "rest", text: "Stop and gather yourself.", aside: "−12 Light · heal 24 where it's needed most", outcomes: [L(-12), A("allUnlocked", -24)] },
        { id: "name", text: "Say your own name like you mean it.", visibleIf: joyPresent, aside: "+12 Light · heal 36 on Mercury", outcomes: [L(12), A("joy", -36)] },
        { id: "borrowed", text: "Try to say your name; it comes out borrowed.", visibleIf: joyAfflicted, aside: "+12 Light · +12 affliction on Mercury", outcomes: [L(12), A("joy", 12)] },
        { id: "push", text: "Don't look too long. Keep walking.", aside: "+24 Light · +24 affliction (you push past yourself)", outcomes: [L(24), A("healthiest", 24)] },
      ],
    },
  },
};
...
const self_stake: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "name", text: "Stake your name on the road ahead.", visibleIf: joyUnlocked, aside: "+48 Light · +36 affliction on Mercury", outcomes: [L(48), A("joy", 36)] },
        { id: "strength", text: "Stake your strength instead.", aside: "+36 Light · +36 affliction", outcomes: [L(36), A("healthiest", 36)] },
...
const livelihood_coin: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "take", text: "Take the one coin and go.", aside: "+24 Light", outcomes: [L(24)] },
    ...
    dig: {
      ...
      options: [
        { id: "stop", text: "Stop while you're ahead.", aside: "+36 Light", outcomes: [L(36)] },
        { id: "keep", text: "Keep digging.", aside: "Fortune (Venus): +72 Light, or +48 affliction", outcomesOnSuccess: [L(72)], outcomesOnFail: [A("healthiest", 48)] },
      ],
    },
  },
};
...
const livelihood_debt: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "borrow", text: "Borrow against tomorrow.", aside: "+60 Light · +48 affliction (the debt comes due)", outcomes: [L(60), A("healthiest", 48)] },
        { id: "little", text: "Take only what you can repay.", aside: "+24 Light · +12 affliction", outcomes: [L(24), A("healthiest", 12)] },
        { id: "leave", text: "Walk away hungry.", aside: "−12 Light", outcomes: [L(-12)] },
      ],
    },
  },
};
...
const communication_letter: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "read", text: "Read it slowly, start to finish.", aside: "−12 Light · heal 24 where it's needed most", outcomes: [L(-12), A("mostAfflicted", -24)] },
        { id: "reply", text: "Write back before you sleep.", visibleIf: joyPresent, aside: "+12 Light · heal 36 on the Moon", outcomes: [L(12), A("joy", -36)] },
        { id: "stuck", text: "Start a reply; nothing comes.", visibleIf: joyAfflicted, aside: "+12 Light · +12 affliction on the Moon", outcomes: [L(12), A("joy", 12)] },
    ...
    carry: {
      ...
      options: [
        { id: "exact", text: "Repeat it word for word.", aside: "+24 Light", outcomes: [L(24)] },
        { id: "own", text: "Tell it the way you'd say it.", aside: "Fortune (Moon): +60 Light, or +36 affliction", outcomesOnSuccess: [L(60)], outcomesOnFail: [A("healthiest", 36)] },
      ],
    },
  },
};
...
const communication_bridge: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "trust", text: "Trust him; take the long way around.", aside: "+12 Light", outcomes: [L(12)] },
        { id: "press", text: "Press on to the bridge anyway.", aside: "Fortune (Moon): +60 Light, or +36 affliction", outcomesOnSuccess: [L(60)], outcomesOnFail: [A("healthiest", 36)] },
        { id: "send", text: "Ask him to carry word back the way you came.", visibleIf: joyPresent, aside: "+12 Light · heal 24 on the Moon", outcomes: [L(12), A("joy", -24)] },
      ],
    },
  },
};
...
const home_hearth: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "sleep", text: "Sleep, and leave at dawn.", aside: "−12 Light · heal 36 across all", outcomes: [L(-12), A("allUnlocked", -36)] },
        { id: "deep", text: "Let the house hold you longer.", visibleIf: rulerStrong, aside: "−24 Light · heal 60 across all", outcomes: [L(-24), A("allUnlocked", -60)] },
        { id: "move", text: "Don't trust an open door. Move on.", aside: "+12 Light", outcomes: [L(12)] },
      ],
    },
  },
};
  ...
  nodes: {
    root: {
      ...
      options: [
        ...
        { id: "take", text: "Take what's yours.", aside: "+48 Light · +36 affliction", outcomes: [L(48), A("healthiest", 36)] },
    ...
    open: {
      ...
      options: [
        { id: "enough", text: "Take what you uncovered and stop.", aside: "+36 Light", outcomes: [L(36)] },
        { id: "all", text: "Take all of it.", aside: "Fortune (Moon): +72 Light, or +48 affliction", outcomesOnSuccess: [L(72)], outcomesOnFail: [A("healthiest", 48)] },
      ],
    },
  },
};
...
const creativity_dice: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "play", text: "Play a round, just for the joy of it.", visibleIf: joyPresent, aside: "+12 Light · heal 36 on Venus", outcomes: [L(12), A("joy", -36)] },
        { id: "hollow", text: "Play, but the game has lost its taste.", visibleIf: joyAfflicted, aside: "+12 Light", outcomes: [L(12)] },
    ...
    bet1: {
      ...
      options: [
        { id: "small", text: "Take a small, sure win.", aside: "+36 Light", outcomes: [L(36)] },
    ...
    bet2: {
      ...
      options: [
        { id: "throw", text: "Throw.", aside: "Fortune (Venus): +96 Light, or +72 affliction on Venus", outcomesOnSuccess: [L(96)], outcomesOnFail: [A("joy", 72)] },
      ],
    },
  },
};
...
const creativity_song: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "finish", text: "Stay up and finish it.", visibleIf: joyUnlocked, aside: "+48 Light · +36 affliction on Venus", outcomes: [L(48), A("joy", 36)] },
        { id: "finish_alt", text: "Stay up and finish it.", visibleIf: joyLocked, aside: "+48 Light · +36 affliction", outcomes: [L(48), A("healthiest", 36)] },
        { id: "rough", text: "Make something rough but done.", aside: "+24 Light · +12 affliction", outcomes: [L(24), A("healthiest", 12)] },
...
const labor_field: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "contained", text: "Let Mars do the job it's made for.", visibleIf: joyPresent, aside: "+36 Light · +12 affliction on Mars (scoped)", outcomes: [L(36), A("joy", 12)] },
        { id: "spill", text: "Force it through; something gives.", visibleIf: joyAfflicted, aside: "+24 Light · +48 affliction on Mars · +24 elsewhere", outcomes: [L(24), A("joy", 48), A("healthiest", 24)] },
        { id: "usual", text: "Take the work at the usual cost.", aside: "+24 Light · +36 affliction", outcomes: [L(24), A("healthiest", 36)] },
        { id: "off", text: "Walk off the job.", aside: "−12 Light", outcomes: [L(-12)] },
      ],
    },
  },
};
...
const labor_fever: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "push", text: "Push through, sick as you are.", aside: "+36 Light · +48 affliction", outcomes: [L(36), A("healthiest", 48)] },
        { id: "sweat", text: "Let Mars sweat it out of you.", visibleIf: joyStrong, aside: "+12 Light · heal 24 on Mars", outcomes: [L(12), A("joy", -24)] },
        { id: "lie", text: "Lie down until it passes.", aside: "−24 Light · heal 36 where it's needed most", outcomes: [L(-24), A("mostAfflicted", -36)] },
      ],
    },
  },
};
...
const relationships_stranger: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "friend", text: "Treat them as a friend.", aside: "+12 Light · heal 12 across all", outcomes: [L(12), A("allUnlocked", -12)] },
    ...
    duel: {
      ...
      options: [
        { id: "back", text: "Step back from it.", aside: "−12 Light", outcomes: [L(-12)] },
        { id: "through", text: "See it through.", aside: "Fortune (Venus): +60 Light, or +36 affliction", outcomesOnSuccess: [L(60)], outcomesOnFail: [A("healthiest", 36)] },
      ],
    },
  },
};
...
const relationships_bargain: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "better", text: "Take the better end.", aside: "+48 Light · +24 affliction", outcomes: [L(48), A("healthiest", 24)] },
        { id: "both", text: "Strike a deal that's good for both.", visibleIf: rulerStrong, aside: "+36 Light · heal 24 across all", outcomes: [L(36), A("allUnlocked", -24)] },
        { id: "fair", text: "Split it down the middle.", aside: "+24 Light · heal 12 across all", outcomes: [L(24), A("allUnlocked", -12)] },
...
const transformation_inheritance: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "take", text: "Take the inheritance.", aside: "+60 Light · +48 affliction", outcomes: [L(60), A("healthiest", 48)] },
    ...
    claim: {
      ...
      options: [
        { id: "clean", text: "Take the clean part.", aside: "+36 Light", outcomes: [L(36)] },
        { id: "debts", text: "Take all of it, debts and all.", aside: "Fortune (Mars): +96 Light, or +72 affliction", outcomesOnSuccess: [L(96)], outcomesOnFail: [A("healthiest", 72)] },
      ],
    },
  },
};
  ...
  nodes: {
    root: {
      ...
      options: [
        ...
        { id: "offer", text: "Offer something of yourself to the dark.", aside: "+48 Light · +48 affliction", outcomes: [L(48), A("healthiest", 48)] },
    ...
    rite: {
      ...
      options: [
        { id: "moon", text: "Call back the Moon.", visibleIf: (c) => combusted(c, "Moon"), aside: "−84 Light · uncombust the Moon", outcomes: [L(-84), UNC("Moon")] },
        { id: "mercury", text: "Call back Mercury.", visibleIf: (c) => combusted(c, "Mercury"), aside: "−84 Light · uncombust Mercury", outcomes: [L(-84), UNC("Mercury")] },
        { id: "venus", text: "Call back Venus.", visibleIf: (c) => combusted(c, "Venus"), aside: "−84 Light · uncombust Venus", outcomes: [L(-84), UNC("Venus")] },
        { id: "sun", text: "Call back the Sun.", visibleIf: (c) => combusted(c, "Sun"), aside: "−84 Light · uncombust the Sun", outcomes: [L(-84), UNC("Sun")] },
        { id: "mars", text: "Call back Mars.", visibleIf: (c) => combusted(c, "Mars"), aside: "−84 Light · uncombust Mars", outcomes: [L(-84), UNC("Mars")] },
        { id: "jupiter", text: "Call back Jupiter.", visibleIf: (c) => combusted(c, "Jupiter"), aside: "−84 Light · uncombust Jupiter", outcomes: [L(-84), UNC("Jupiter")] },
        { id: "saturn", text: "Call back Saturn.", visibleIf: (c) => combusted(c, "Saturn"), aside: "−84 Light · uncombust Saturn", outcomes: [L(-84), UNC("Saturn")] },
...
const pilgrimage_teacher: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "listen", text: "Sit and listen till morning.", aside: "+12 Light · heal 24 where it's needed most", outcomes: [L(12), A("mostAfflicted", -24)] },
        { id: "study", text: "Study what the light shows you.", visibleIf: joyPresent, aside: "+24 Light · heal 36 on the Sun", outcomes: [L(24), A("joy", -36)] },
        { id: "wont", text: "Listen, but the lesson won't take.", visibleIf: joyAfflicted, aside: "+12 Light", outcomes: [L(12)] },
        { id: "move", text: "Move on at first light.", aside: "+12 Light", outcomes: [L(12)] },
      ],
    },
  },
};
...
const pilgrimage_vow: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "keep", text: "Make the vow, and mean to keep it.", aside: "+48 Light · +24 affliction", outcomes: [L(48), A("healthiest", 24)] },
    ...
    vow: {
      ...
      options: [
        { id: "hold", text: "Hold to it.", aside: "+36 Light", outcomes: [L(36)] },
        { id: "break", text: "Break it when it suits you.", aside: "Fortune (Sun): +60 Light, or +48 affliction on the Sun", outcomesOnSuccess: [L(60)], outcomesOnFail: [A("joy", 48)] },
      ],
    },
  },
};
...
const achievement_summit: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "praise", text: "Speak, and take the praise.", aside: "+48 Light · +24 affliction", outcomes: [L(48), A("healthiest", 24)] },
        { id: "plain", text: "Speak plainly, and briefly.", aside: "+24 Light", outcomes: [L(24)] },
        { id: "quiet", text: "Step back into the quiet.", aside: "−12 Light · heal 24 where it's needed most", outcomes: [L(-12), A("mostAfflicted", -24)] },
      ],
    },
  },
};
...
const achievement_monument: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "stone", text: "Lay a single, modest stone.", aside: "+36 Light", outcomes: [L(36)] },
    ...
    build: {
      ...
      options: [
        { id: "finish", text: "Finish it as planned.", aside: "+48 Light", outcomes: [L(48)] },
        { id: "greater", text: "Make it greater still.", aside: "Fortune (Saturn): +96 Light, or +72 affliction", outcomesOnSuccess: [L(96)], outcomesOnFail: [A("healthiest", 72)] },
      ],
    },
  },
};
...
const friendship_gift: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "take", text: "Take the gift, and the company.", visibleIf: joyPresent, aside: "+24 Light · heal 36 on Jupiter", outcomes: [L(24), A("joy", -36)] },
        { id: "noone", text: "There is no one at the gate.", visibleIf: joyAfflicted, aside: "−12 Light", outcomes: [L(-12)] },
        { id: "sit", text: "Sit and catch up first.", aside: "+12 Light · heal 24 across all", outcomes: [L(12), A("allUnlocked", -24)] },
        { id: "hurry", text: "Take it and hurry on.", aside: "+24 Light", outcomes: [L(24)] },
      ],
    },
  },
};
...
const friendship_favor: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "all", text: "Ask for everything you need.", visibleIf: joyUnlocked, aside: "+48 Light · +24 affliction on Jupiter", outcomes: [L(48), A("joy", 24)] },
        { id: "all_alt", text: "Ask for everything you need.", visibleIf: joyLocked, aside: "+48 Light · +24 affliction", outcomes: [L(48), A("healthiest", 24)] },
        { id: "little", text: "Ask for just a little.", aside: "+24 Light", outcomes: [L(24)] },
...
const hidden_weight: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "named", text: "Carry it, and name it plainly.", visibleIf: joyPresent, aside: "+24 Light · +12 affliction on Saturn (scoped)", outcomes: [L(24), A("joy", 12)] },
        { id: "unnamed", text: "Carry it unnamed; it grows heavier.", visibleIf: (c) => joyAfflicted(c) || joyLocked(c), aside: "+12 Light · +48 affliction · +24 elsewhere", outcomes: [L(12), A("healthiest", 48), A("mostAfflicted", 24)] },
        { id: "down", text: "Set down what you can.", aside: "−24 Light · heal 24 where it's needed most", outcomes: [L(-24), A("mostAfflicted", -24)] },
      ],
    },
  },
};
...
const hidden_door: NarrativeTree = {
  ...
  nodes: {
    root: {
      ...
      options: [
        { id: "glance", text: "Take a glance, and a little with it.", aside: "+24 Light · +24 affliction", outcomes: [L(24), A("healthiest", 24)] },
    ...
    exile: {
      ...
      options: [
        { id: "what", text: "Take what you came for.", aside: "+36 Light", outcomes: [L(36)] },
        { id: "deeper", text: "Go deeper.", aside: "Fortune (Saturn): +72 Light, or +60 affliction", outcomesOnSuccess: [L(72)], outcomesOnFail: [A("healthiest", 60)] },
      ],
    },
  },
};
