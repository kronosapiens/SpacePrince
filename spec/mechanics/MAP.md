...
It covers topology only. Visual/aesthetic treatment lives in `spec/design/VIBES.md` ("The Map as Sephirot"). Encounter semantics (what lives at each node) and traversal mechanics are out of scope for v1.

Reference implementation: `spec/design/tree.html` — interactive prototype with live layer sliders, pattern overrides, and reseed.
