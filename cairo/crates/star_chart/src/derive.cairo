...
use crate::types::{
    ...
    DIGNITY_FALL, DIGNITY_NEUTRAL, SECT_DAY, SECT_NIGHT,
};
...
pub fn chart_sect_code(is_day_chart: bool) -> u8 {
    if is_day_chart { SECT_DAY } else { SECT_NIGHT }
}
...
mod tests {
    ...
    use crate::types::{DIGNITY_DETRIMENT, DIGNITY_DOMICILE, DIGNITY_EXALTATION};

    use super::{derive_dignity, derive_house, sign_aspect_class};
